...
const initialState: UserSharePostState = {
  post: {
    commentModalState: {
      isOpen: false,
    },
...
export const userSharePostSlice = createSlice({
  name: "userSharePostSlice",
  initialState,
  reducers: {
...
export const {
  ...
  openReactionModalForThisReply,
  openReactionModalForThisReplyReply,
} = userSharePostSlice.actions;

export default userSharePostSlice.reducer;

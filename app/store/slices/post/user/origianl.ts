...
interface OriginalUserPostState {
  post: {
    commentModalState: {
      isOpen: boolean;
    };
...
const initialState: OriginalUserPostState = {
  post: {
    commentModalState: {
      isOpen: false,
    },
...
export const OriginalUserPostSlice = createSlice({
  name: "OriginalUserPostSlice",
  initialState,
  reducers: {
...
export const {
  ...
  openReactionModalForThisReply,
  openReactionModalForThisReplyReply,
} = OriginalUserPostSlice.actions;

export default OriginalUserPostSlice.reducer;

...
interface OriginalPagePostState {
  post: {
    commentModalState: {
      isOpen: boolean;
    };
...
const initialState: OriginalPagePostState = {
  post: {
    commentModalState: {
      isOpen: false,
    },
...
export const originalPagePostSlice = createSlice({
  name: "originalPagePostSlice",
  initialState,
  reducers: {
...
export const {
  ...
  openReactionModalForThisReply,
  openReactionModalForThisReplyReply,
} = originalPagePostSlice.actions;

export default originalPagePostSlice.reducer;

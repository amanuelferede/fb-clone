...
const initialState: PageSharePostState = {
  post: {
    commentModalState: {
      isOpen: false,
    },
...
export const pageSharePostSlice = createSlice({
  name: "pageSharePostSlice",
  initialState,
  reducers: {
...
export const {
  ...
  openReactionModalForThisReply,
  openReactionModalForThisReplyReply,
} = pageSharePostSlice.actions;

export default pageSharePostSlice.reducer;

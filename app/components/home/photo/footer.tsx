...
export default function Footer() {
  ...
  return (
    <div className="relative ">
      {toShowReactionBox && (
        <div
          className={`w-[90%] flex space-x h-auto bg-white shadow-sm rounded-3xl absolute left-2 bottom-11.5 `}
        ...
        >
          <Image
            ...
            height={0}
            sizes="100vh"
            className="w-11 h-11 rounded-full cursor-pointer  block reaction-emoji-animation"
          />
          <Image
            alt="like"
      ...
      <div className=" flex items-center justify-between px-2 pb-1.5">
        ...
        >
          <Image
            ...
            height={20}
          />
          <p className="font-semibold text-zinc-500 text-[0.93rem]">Like</p>
        </div>
        <div className="flex  space-x-1 grow px-1.5 py-1.5 items-center justify-center cursor-pointer rounded-sm hover:bg-zinc-50">
          ...
          />
          <p className="font-semibold text-zinc-500 text-[0.93rem]">Comment</p>
        </div>
        <div className="flex  space-x-1 grow px-1.5 py-1.5 items-center justify-center cursor-pointer rounded-sm hover:bg-zinc-50">
          <Image
            alt="share"
            ...
            height={20}
          />
          <p className="font-semibold text-zinc-500 text-[0.93rem]">Share</p>
        </div>
      </div>
    </div>
  );
